...
_detalhes:InstallSkin ("ShestakUI", {
	...
	instance_cprops = {
		...
		["row_info"] = {
			...
			["font_face_file"] = "Interface\\AddOns\\ShestakUI\\Media\\Fonts\\Normal.ttf",
			["backdrop"] = {
				["enabled"] = false,
				["size"] = 12,
				["color"] = {
			...
			-- ["texture_custom_file"] = "AddOns\\ShestakUI\\Media\\Textures\\Texture.tga",
